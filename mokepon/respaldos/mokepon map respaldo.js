...
let hipodogeEnemy = new Mokepon('Hipodoge', './assets/hipodoge.png', 5, './assets/hipodoge_head.png')
let capipepoEnemy = new Mokepon('Capipepo', './assets/capipepo.png', 5, './assets/capipepo_head.png')
let ratigueyaEnemy = new Mokepon('Ratigueya', './assets/ratigueya.png', 5, './assets/ratigueya_head.png')
